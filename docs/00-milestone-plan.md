...
| **Last updated** | 5 July 2026 (v0.2.0 shipped and tagged `v0.2.0`; Milestones 15–16 signed off — the v0.3.0 brief and the design system (`docs/06-design-system.md`) with new NFR-11; Milestone 17, architecture & API deltas, is the current position) |
