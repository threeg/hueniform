...
| **Last updated** | 5 July 2026 (v0.2.0 shipped and tagged `v0.2.0`; v0.3.0 planning complete — Milestones 15–19 signed off (brief, design system with new NFR-11, architecture styling note, wireframe/responsive deltas with NFR-7 amended, test-strategy delta + tickets HUE-094–105); Milestone 20, implementation in Claude Code, is the current position) |
