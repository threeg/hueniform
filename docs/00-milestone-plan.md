...
| **Last updated** | 5 July 2026 (v0.2.0 shipped and tagged `v0.2.0`; Milestones 15–18 signed off — the v0.3.0 brief, the design system (`docs/06-design-system.md`) with new NFR-11, the architecture styling note, and the wireframe/responsive deltas with NFR-7 amended; Milestone 19, test-strategy delta + ticket generation, is the current position) |
...
| 19 | Test-strategy delta + ticket generation | `docs/05-test-strategy.md` visual-fidelity/regression approach; `tickets/*` (HUE-094+), epics E11–E12 | **Cowork** | 🔶 In progress |
