...
| 5 | Test strategy | `spec/test-strategy/test-strategy.md` — frameworks, what is unit/integration/E2E tested | Cowork | ⬜ |
| 6 | Ticket generation | `spec/tickets/*.md` + conventions + `BOARD.md` index | Cowork | ⬜ |
...
| 13 | Test-strategy delta + ticket generation | updated `spec/test-strategy/test-strategy.md`; new tickets | Cowork | ⬜ |
