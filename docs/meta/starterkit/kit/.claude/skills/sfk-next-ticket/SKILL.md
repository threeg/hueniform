...
commit. Follow the ticket-workflow rules in `spec/tickets/CLAUDE.md` and the definition of done in
the root `CLAUDE.md`.

## Procedure

1. **Pick the ticket.** From `spec/tickets/BOARD.md`, take the lowest-numbered `todo` ticket whose
