...
batch: screen
layer: frontend
depends_on: [HUE-096, HUE-097, HUE-098, HUE-034]
...
## In plain English
Applies the new look and the phone/tablet/desktop layouts to confirm-and-correct, without changing what it does.

## User story
As the owner
I want confirm-and-correct to match the new design and adapt to my screen size
so that it is attractive and usable everywhere.

## Acceptance criteria

**Scenario 1: Restyled to the design system**
- Given the confirm-and-correct screen (image preview, proportion editor, category picker, all states)
...
## Design references
- Wireframes: docs/04-wireframes/02-confirm-and-correct.md (all states); docs/04-wireframes/07-responsive.md §4; design system §5–§6
