...
- [ ] Clustering correct including the wrap; scheme test returns the first matching scheme in FR-13 order
- [ ] Tolerance boundaries correct (the §4.5 rows); neutrals never change the matched scheme (FR-14)
- [ ] FR-15's harmony predicate composes scheme-set satisfaction (exercised end-to-end in slots/ranking)
